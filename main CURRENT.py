...
Architecture matches cocodem EXACTLY:
  ...
  - Service worker, HTML files, inline scripts: UNTOUCHED
...
if (globalThis.window) {
  ...
  if (location.pathname == "/options.html") {
    // MutationObserver: inject Backend Settings link above Log out in sidebar nav
    const _observer = new MutationObserver(() => {
      ...
      link.href = "http://localhost:''' + str(CFC_PORT) + r'''/backend_settings"
      link.target = "_blank"
...
def main():
    ...
    write_options()            # writes backend_settings.html/css/js
